...
# Project:  Project.pro
# Template: app
# Command: C:\Qt\6.2.1\mingw81_64\bin\qmake.exe -o Makefile Project.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: Project.pro C:/Qt/6.2.1/mingw81_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.2.1/mingw81_64/mkspecs/features/spec_pre.prf \
